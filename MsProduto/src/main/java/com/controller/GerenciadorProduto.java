...
public class GerenciadorProduto {
	...
	@RequestMapping(value = "produto/atualizaEstoque/{id}/{quantidade}", method = {RequestMethod.GET, RequestMethod.POST})
	private Boolean atualizaEstoque(@PathVariable("id") String id, @PathVariable("quantidade") String quantidade) {
